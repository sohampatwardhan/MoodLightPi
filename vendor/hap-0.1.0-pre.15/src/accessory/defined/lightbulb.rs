...
impl LightbulbAccessory {
    ...
    pub fn new(id: u64, information: AccessoryInformation) -> Result<Self> {
        ...
        let lightbulb_id = accessory_information
            .get_characteristics()
            .iter()
            .map(|characteristic| characteristic.get_id())
            .max()
            .unwrap_or(accessory_information.get_id());
        let mut lightbulb = LightbulbService::new(lightbulb_id + 1, id);
